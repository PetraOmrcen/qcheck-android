...
class MyPlacesViewModelTest : TestCase() {
    ...
    public override fun setUp() {
        ...
        viewModel = MyPlacesViewModel(repository)
    }

    @Test
    fun testGetMyPlaces() {
        viewModel.getMyPlaces(17)
        val result = viewModel.myplaces.getOrAwaitValue1(2, TimeUnit.SECONDS)
